# 🔥 HealthAI
HealthAI - Инновационный инструмент для развития коммуникации врач - пациент с открытым исходным кодом. Бот позволяет врачам 
...
## Где гарантии оплаты моей работы пациентом?
Врач может выстовить счёт за приём пациента сразу после того, как он поступил,
если врач не уверен в пациенте и/или не доверяет нашей системе. Однако если
счёт был выставлен после оказания услуги и пациент не оплатил счёт в течении
2-х рабочих дней - Вы можете обратиться к любому из администратором, список
которых можно получить через команду _/list admin_. Мы постараемся решить
...
Является хорошим способом поддержать развивающийся проект. Подписка не может быть
анулирована администрацией ни при каких обстоятельствах, за исключением истечения
срока действия
...
материальных вложений. В будущем в коммерции проекта будут послабления. Вы
можете поддержать наш проект и на странице GitHub
...
### · Ложные жалобы или несерьёзные сообщения в команде _/complaints_ полностью запрещены!
...
#### · Используя нашу платформу, не принимать платежи от пациентов на стороне
...
# 📃 Помощь по командам
#### · /help - Открывает README.md на нашем гитхабе
#### · /ads - Рекламный кабинет. Содержит разделы необходимые рекламодателям и людям, желающим отказаться от просмотра рекламы
#### · /search [Запрос] - Свободный запрос к ChatGPT, доступный только врачам
#### · /settings - Кабинет настроек пользователя
#### · /reset - Перезапуск бота в случае ошибок
#### · /list [doctor | admin] - Список докторов или администраторов. Если пропустить аргумент, будет выведен список врачей и администраторов сразу
#### · /admin - Админ-панель, доступная только для администрации и модерации проекта
#### · /start - Команда запуска бота
#### · /profile - Выводит профиль пользователя. Команда /start имеет аналогичное действие, если пользователь зарегистрирован
#### · /complaint - Жалоба / Предложение, которое будет отправлено случайному администратору со ссылкой на Ваш аккаунт
#### · /stop - Остановка диалога с собеседником
#### · /sponsor - Ссылки на безвозмездную поддержку проекта
#### · /forum - Общий форум проекта

# 📊 Политика размещения рекламы
#### · Модерация проекта может снять рекламное объявление с показа по изложенным ниже правилам, вернув 85% от уплоченной суммы
#### · Рекламные материалы не должны содержать материалы сексуального характера / шокирующий контент
#### · Реклама отображается в диалоге каждого пользователя раз в 6 часов
#### · Пользователь может игнорировать рекламу, оформив подписку HealthPremium
#### · Рекламные материалы не могут являтся пропогандой чего-либо
#### · Реклама должна быть добросовестной и достоверной, не содержать фейков
#### · Рекламные материалы не должны нарушать [Федеральный закон Российской Федерации "О рекламе" от 13.03.2006 N 38-ФЗ](https://www.consultant.ru/document/cons_doc_LAW_58968/)
